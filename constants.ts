...
export const USERS: User[] = [
  ...
  { id: 'user-7', name: 'Govind Vashishtha', color: 'bg-pink-900', calendarId: 'govind.vashishtha@pwr.edu.pl' , invitationCalId: 'govind.vashishtha@pwr.edu.pl', active: false },
  { id: 'user-8', name: 'Sumika Chauhan', color: 'bg-purple-700', calendarId: 'sumika.sumika@pwr.edu.pl', invitationCalId: 'sumika.sumika@pwr.edu.pl', active: false },
