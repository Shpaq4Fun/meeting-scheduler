...
export const Controls: React.FC<ControlsProps> = ({
  ...
  return (
    <div className="flex flex-col gap-4 rounded-lg bg-[#1a202c]/0">
      ...
      <Button style={{maxWidth: 350 + 'px', borderRadius: 25 + 'px'}} onClick={onCreateMeeting} disabled={isGenerateDisabled}>
        {isGenerateDisabled
      ...
      <Button style={{maxWidth: 350 + 'px', borderRadius: 25 + 'px'}} onClick={onSendInvitation} disabled={isInvitationDisabled}>
